<?php
    //para hindi na oopen ng iba
    session_start();
    include "../../config/database.php";
    //validation - only admin can access this page
    if (!isset($_SESSION["role"]) || $_SESSION["role"] != "admin"){
        header("Location: ../../index.php"); //location kung saan pupunta
        exit;
    }
    ...
    if(isset($_POST["save"])){
        ...
        if(mysqli_query($conn, $sql)){
            header("Location: index.php?message=You have successfully added a Student Record!");
            exit;
        }

        else{
            $message = "Student Record could not be saved.";
        }
    }
?>
